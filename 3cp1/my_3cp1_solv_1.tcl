...
puts $fp "
output ${inputname}_packed_stage1.pdb
filetype pdb
seed $seed
tolerance 2.0
structure prot.pdb
...
puts $fp "
output ${inputname}_packed_stage2.pdb
filetype pdb
seed $seed
tolerance 2.0
structure ${inputname}_packed_stage1.pdb
  number 1
  fixed 0. 0. 0. 0. 0. 0.
end structure
# z(+) leaflet
...
puts $fp "
output ${inputname}_packed.pdb
filetype pdb
seed $seed
tolerance 2.0
structure ${inputname}_packed_stage2.pdb
  number 1
  fixed 0. 0. 0. 0. 0. 0.
end structure
structure TIP3.pdb
