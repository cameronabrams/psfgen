...
set r [atomselect top "protein and chain A and name CA and resid 696 to 992"]
...
set a [atomselect top all]
$a set beta 0.0
set b [atomselect top "name CA and chain A and resid 696 to 992"] 
$b set beta 1.0
