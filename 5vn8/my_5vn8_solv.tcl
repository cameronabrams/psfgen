...
set a [atomselect top all]
$a set beta 0.0
set b [atomselect top "name CA and chain G E D and resid 253 to 301 322 to 396 411 to 475"] 
set rcm [measure center $b]
$b set beta 1.0
$b writepdb "${inputname}_caB1.pdb"

set fp [open "${inputname}_colvars_op.inp" "w"]
puts $fp "colvarstrajfrequency 100
colvar {
  name prot_orientation
  orientation {
    atoms {
      psfSegID G G G E E E D D D
    ...
    refpositionsfile ${inputname}_caB1.pdb
    refpositionscol B
  }
}
