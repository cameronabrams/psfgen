...
def WritePostMods(fp,psf,pdb,PostMod,Loops,GlycanSegs):
    ...
    if 'do_loop_mc' in PostMod and PostMod['do_loop_mc']:
        ...
        fp.write('set sigma 2.0\n')
        fp.write('set epsilon 1.0\n')
        fp.write('set r0 1.5\n')
    ...
    if 'do_gly_mc' in PostMod and PostMod['do_gly_mc']:
        ...
        fp.write('   do_flex_mc $molid $sel $li $ri $fa 0 -1 -1 $bg $sigma $epsilon $rcut $nc $temperature [irand_dom 1000 9999] $logid {}\n'.format(logevery))
        fp.write('}\n')
