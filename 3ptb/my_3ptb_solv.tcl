...
set r [atomselect top "protein and chain A and name CA"]
set c [measure center $r]
...
set a [atomselect top all]
$a set beta 0.0
set b [atomselect top "name CA and chain A"] 
$b set beta 1.0
$b writepdb ${inputname}_caB1.pdb

set fout [open fixed-atoms-list.dat "w"]
set $fout [$b get serial]
